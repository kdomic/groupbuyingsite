    ...
    class DatabaseObject {
        ...
        protected function sanitized_attributes() {
            ...
            foreach($this->attributes() as $key => $value)
                $clean_attributes[$key] = $database->db_escape_value($value);
        ...
        public function update() {
            ...
            $sql .= " WHERE id=". $database->db_escape_value($this->id);
            $database->db_query($sql);
            return ($database->db_affected_rows() == 1) ? true : false;
        }
