<?php
    ...
    class Vrijeme extends DatabaseObject {
        ...
        public static function nowWithOffset(){
            $vrijeme = self::find_by_id(1);
            $date = date('Y-m-d H:i:s', strtotime(date("Y-m-d H:i:s"))+(1*60*60*(int)$vrijeme->pomak));
            return $date;
        }
        ...
        public static function remainingTimeWithOffset($datetime){
            $future = strtotime($datetime);
